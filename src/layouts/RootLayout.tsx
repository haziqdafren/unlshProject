...
export default function RootLayout({ children }: RootLayoutProps) {
  return (
    <Website>
      <Helmet>
        <title>Unlsh — Executive Coaching &amp; Mentoring Community</title>
        <meta name="description" content="Unlsh is a hybrid executive coaching and mentoring community combining world-class guidance, expert access, and inner transformation for high achievers." />
      </Helmet>
      <ScrollRestoration />
      <Header />
      {children}
