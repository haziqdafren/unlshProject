...
const COUNTRY_CODES: { code: string; name: string }[] = [
  // Default entry — shown first
  { code: '+852', name: 'Hong Kong SAR' },
  // Alphabetical list
